...
<html>
	<head>
		<meta charset="utf-8">
		<title>Mobile Innovation | 會員註冊</title>
					...
					<div class="row">
						<div class="main object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="300">
							<div class="form-block center-block">
								...
								<hr>
								<form class="form-horizontal" method="post" action="<%=context %>/from/user_register">
									<div class="form-group has-feedback">
										<label for="inputUserName" class="col-sm-3 control-label">使用者名稱</label>
										<div class="col-sm-8">
											<input type="text" class="form-control" name="username" id="inputUserName" placeholder="使用者名稱" required>
											<i class="fa fa-user form-control-feedback"></i>
										</div>
									</div>
									<div class="form-group has-feedback">
										...
										<div class="col-sm-8">
											<input type="password" class="form-control" name="password" id="inputPassword" placeholder="密碼" required>
											<i class="fa fa-lock form-control-feedback"></i>
										</div>
									</div>
									<div class="form-group has-feedback">
										<label for="inputPassword2" class="col-sm-3 control-label">確認密碼</label>
										<div class="col-sm-8">
											<input type="password" class="form-control" name="password2" id="inputPassword2" placeholder="密碼" required>
											<i class="fa fa-lock form-control-feedback"></i>
										</div>
									</div>
									<div class="form-group has-feedback">
									...
									<div class="form-group has-feedback">
										<label for="inputRand" class="col-sm-3 control-label">驗證碼</label>
										<div class="col-sm-4">
											<input type="text" class="form-control" name="rand" id="inputRand" placeholder="驗證碼" required>
										</div>
										<div class="col-sm-4">
									...
									<div class="form-group">
										<div class="col-sm-offset-3 col-sm-8">									
											<button type="submit" class="btn btn-group btn-default btn-sm">註冊</button>
										</div>
									</div>
								</form>
							</div>

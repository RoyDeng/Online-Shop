...
<html>
	<head>
		<meta charset="utf-8">
		<title>Mobile Innovation | 關於我們</title>
				...
				<div class="container">
					...
					<div class="row grid-space-20">
						<div class="col-lg-6 col-md-12">
							<div class="image-box team-member option-3">
								<div class="overlay-container">
									<img src="<%=context %>/images/10344140.jpg" alt="">
									<div class="overlay">
								...
								<div class="image-box-body">
									<h3 class="title">鄧宇騰</h3>
									<small>網站程式設計師</small>
									<div class="separator-2"></div>
									<p>從事網際網路系統軟硬體與程式語言的製作、測試及安裝。</p>
									<ul class="list-unstyled">
										<li><i class="fa fa-phone pr-10"></i>03-4194571</li>
										<li><i class="fa fa-mobile pr-10 pl-5"></i>0987721426</li>
										<li><i class="fa fa-envelope pr-10"></i><a href="mailto:xoxo4795946@yahoo.com.tw">xoxo4795946@yahoo.com.tw</a></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-md-12">
							<div class="image-box team-member option-3">
								<div class="overlay-container">
									<img src="<%=context %>/images/10344146.jpg" alt="">
									<div class="overlay">
										<ul class="social-links colored clearfix">
											<li class="instagram"><a target="_blank" href="https://www.instagram.com/aab8057/"><i class="fa fa-instagram"></i></a></li>
											<li class="googleplus"><a target="_blank" href="https://plus.google.com/u/0/117991441950813086047"><i class="fa fa-google-plus"></i></a></li>
											<li class="facebook"><a target="_blank" href="https://www.facebook.com/profile.php?id=100001674499628"><i class="fa fa-facebook"></i></a></li>
										</ul>
									</div>
								</div>
								<div class="image-box-body">
									<h3 class="title">黃芷琳</h3>
									<small>助理</small>
									<div class="separator-2"></div>
									<p>協助資訊專業人員進行電腦軟體的開發、測試、管理及維護。</p>
									<ul class="list-unstyled">
										<li><i class="fa fa-mobile pr-10 pl-5"></i>0953368546</li>
										<li><i class="fa fa-envelope pr-10"></i><a href="mailto:abc77585@gmail.com">abc77585@gmail.com</a></li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<blockquote class="inline">
								<p class="margin-clear">求知若飢，虛心若愚。</p>	

...
<html>
	<head>
		<meta charset="utf-8">
		<title>Mobile Innovation | 會員登入</title>
					...
					<div class="row">
						<div class="main object-non-visible" data-animation-effect="fadeInDownSmall" data-effect-delay="300">
							<div class="form-block center-block">
								...
								<hr>
								<form class="form-horizontal" method="post" action="<%=context %>/from/loginaction">
									<div class="form-group has-feedback">
									...
									<div class="form-group">
										<div class="col-sm-offset-3 col-sm-8">									
											<button type="submit" class="btn btn-group btn-default btn-sm">登入</button>
										</div>
									</div>
								</form>
							</div>
							<p class="text-center space-top">還沒有帳戶？ 立即<a href="<%=context %>/userregister.jsp">註冊</a>。</p>
						</div>
					</div>
				</div>
			</section>

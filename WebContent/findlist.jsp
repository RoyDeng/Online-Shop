...
<html>
	<head>
		<meta charset="utf-8">
		<title>Mobile Innovation | 商品清單</title>
					...
					<div class="row">
						<div class="main col-md-12">
								...
								<div class="col-md-4 col-sm-6 masonry-grid-item">
									<div class="listing-item">
										...
										<div class="listing-item-body clearfix">
											<h3 class="title"><s:property value="#p.name"/></h3>
											<p><s:property value="#p.description"/></p>
											<span class="price"><s:property value="#p.price"/></span>
											<div class="elements-list pull-right">
												<a href="<%=context %>/from/addaction!addItem?productId=<s:property value="#p.id"/>""><i class="fa fa-shopping-cart pr-10"></i>放入購物車</a>
											</div>
										</div>
									</div>
								</div>
							...
							<ul class="pagination">
								...
								<s:if test="#page>1"><li><a href="<%=context %>/from/listaction!list?page=1">第一頁</a></li></s:if><s:if test="#page>1 "><li><a href="<%=context %>/from/listaction!list?page=${page-1}">上一頁</a></li></s:if>
								<s:if test="#page< #maxpage "><li><a href="<%=context %>/from/listaction!list?page=${page + 1}">下一頁</a></li></s:if>
								<s:if test="#page< #maxpage  "><li><a href="<%=context %>/from/listaction!list?page=${maxpage}">最後一頁</a></li></s:if>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<blockquote class="inline">
								<p class="margin-clear">每當我害怕失去某些東西，我都想到人將有一死；這件事提醒了我，沒有什麼理由不去追尋你內心渴望的東西。</p>	

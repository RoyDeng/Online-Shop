...
<html>
	<head>
		<meta charset="utf-8">
		<title>Mobile Innovation | 結帳</title>
	...
	<body class="no-trans">
				...
				<div class="container">
					<div class="row">
						<div class="main col-md-12">
							<h1 class="page-title margin-top-clear">結帳</h1>
							<div class="space"></div>
							<table class="table cart table-striped">
								...
								<tbody>
										...
										<tr>
											...
											<td class="quantity">
												<div class="form-group">
													<input type="text" class="form-control" value="${item.value.number }" disabled>
												</div>											
											</td>
											<td class="amount">${item.value.cost }</td>
										</tr>
									...
									<tr>
										<td class="total-quantity" colspan="3">消費總金額</td>
										<td class="total-amount">${sessionScope.cart.price }</td>
									</tr>
								</tbody>
							</table>
							<div class="space-bottom"></div>
							<fieldset>
								<form role="form" class="form-horizontal" id="billing-information" action="<%=context %>/from/cart_post!postOrder" method="post">
									<div class="row">
										<div class="col-lg-3">
										...
										<div class="col-lg-8 col-lg-offset-1">
											<div class="form-group">
												<label for="billingAddress1" class="col-md-2 control-label">姓名<small class="text-default">*</small></label>
												<div class="col-md-10">
													<input type="text" class="form-control" id="billingAddress1" value="${sessionScope.user.name }">
												</div>
											</div>
											<div class="form-group">
												<label for="billingAddress2" class="col-md-2 control-label">Email</label>
												<div class="col-md-10">
													<input type="text" class="form-control" id="billingAddress2" value="${sessionScope.user.email }">
												</div>
											</div>
											<div class="form-group">
												<label for="billingCity" class="col-md-2 control-label">室內電話<small class="text-default">*</small></label>
												<div class="col-md-10">
													<input type="text" class="form-control" id="billingCity" value="${sessionScope.user.phone }">
												</div>
											</div>
											<div class="form-group">
												<label for="billingCity" class="col-md-2 control-label">行動電話<small class="text-default">*</small></label>
												<div class="col-md-10">
													<input type="text" class="form-control" id="billingCity" value="${sessionScope.user.mobile }">
												</div>
											</div>
											<div class="form-group">
												<label for="billingPostalCode" class="col-md-2 control-label">聯絡地址<small class="text-default">*</small></label>
												<div class="col-md-10">
													<input type="text" class="form-control" id="billingPostalCode" value="${sessionScope.user.address }">
												</div>
											</div>
										</div>
									</div>
							...
							<div class="text-right">	
								<a class="btn btn-group btn-default btn-sm" onclick="javascript:location.href='listaction?method=list'">繼續購物</a>
								<a class="btn btn-group btn-default btn-sm" onclick="javascript:location.href='cart_inedx?method=CartIndex'"><i class="icon-left-open-big"></i>返回購物車</a>
								<a class="btn btn-group btn-default btn-sm" onclick="myFunction()">結帳<i class="icon-right-open-big"></i></a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<blockquote class="inline">
								<p class="margin-clear">我們一生沒辦法做太多事情，所以每件事都要做到精彩絕倫，因為這就是我們的人生。</p>	
								...
								<nav class="navbar navbar-default" role="navigation">
									...
									<div class="collapse navbar-collapse" id="navbar-collapse-2">
										<ul class="nav navbar-nav">
											...
											<li><a href="privacy.jsp">隱私權政策</a></li>
		...
		<script type="text/javascript" src="<%=context %>/plugins/jquery.min.js"></script>
		...
		<script>
			function myFunction() {
				document.getElementById("billing-information").submit();
			}
		</script>
	</body>
</html>
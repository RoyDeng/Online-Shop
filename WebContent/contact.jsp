...
<html>
	<head>
		<meta charset="utf-8">
		<title>Mobile Innovation | 聯絡我們</title>
				...
				<div class="container">
					<div class="row">
						<div class="main col-md-12">
							...
							<div class="row">
								<div class="col-md-6">
									<p>親愛的貴賓您好，如果您想更了解Mobile Innovation，或是其他有任何疑問，歡迎您線上留言給我們，收到您的訊息後，我們盡快請專人回覆您的問題。謝謝您！</p>
									<div class="alert alert-success hidden" id="MessageSent">
										已經收到您的訊息，我們將迅速與您聯絡。
									</div>
									<div class="alert alert-danger hidden" id="MessageNotSent">
										糟糕！發生錯誤，請重新整理頁面並再次嘗試。
									</div>
									<div class="contact-form">
										<form id="contact-form" role="form">
											...
											<input type="submit" value="送出" class="submit-button btn btn-default">
										</form>
									</div>
								</div>
								<div class="col-md-6">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<blockquote class="inline">
								<p class="margin-clear">創新，決定了誰是領導者，誰是追隨者。</p>	
